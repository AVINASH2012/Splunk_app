...
const runCommands = {
    win32: {
        ...
        demo: () => shell.exec('.\\node_modules\\.bin\\webpack-dev-server --config .\\demo\\webpack.standalone.config.js --port 8080'),
        link: () => shell.exec('mklink /D "%SPLUNK_HOME%\\etc\\apps\\react-todo-list" "%cd%\\demo\\splunk-app"'),
    },
    nix: {
        ...
        link: () => shell.exec('ln -s $PWD/demo/splunk-app $SPLUNK_HOME/etc/apps/react-todo-list-demo-app'),
    },
};
